...
func (p *EventController) SearchEvent(c *fiber.Ctx) error {
	var (
...
func (p *EventController) GetOneEvent(c *fiber.Ctx) error {
	var (
...
func (p *EventController) RegisterEvent(c *fiber.Ctx) error {
	var (
		err error
		id  uint
...
func (p *EventController) DownloadEventTicket(c *fiber.Ctx) error {
	var (
		err error
		id  uint
